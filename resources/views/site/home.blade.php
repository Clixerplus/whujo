<x-guest-layout>
    ...
    <header class="relative h-auto max-w-screen ">
        ...
        <div class="relative flex items-center bg-third-variant2  bg-opacity-90 w-full h-full overflow-x-hidden">
                    ...
                    <div class="text-center pt-4">
                        ...
                        <div id="banner"
                            ...
                            <h2 class="max-w-full mb-6 font-sans text-4xl font-bold text-white sm:text-5xl md:mx-auto">
                                ...
                                <span class="block w-full text-transparent bg-clip-text text-warning lg:inline">
                        ...
                        <div class="flex flex-wrap md:justify-center mb-10 md:mb-16">
                            ...
                            <div class="m-2">
                                ...
                                <a href="{{-- route('listing',['category'=>$category->id]) --}}"
                                    class="flex h-10 items-center space-x-2 rounded-full font-light text-white bg-gray-300 bg-opacity-20 py-1 px-4">
        ...
        <div class="top-auto bottom-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden text-gray-50"
            ...
            <svg class="absolute bottom-0 overflow-hidden -mb-0.5" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:pt-20">
                <div class="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
                    <h2 class="max-w-lg text-3xl font-semibold
                               sm:text-4xl border-b-4 border-useful pb-2">
    ...
    <section class="relative max-w-screen bg-gray-50 -mt-0.5">
        <div class="container mx-auto px-4 ">
            <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                ...
                <div class="w-full">
                    {{--
                    <x-embla-carousel id="expeCarousel" route="'experiences'" :items="$experiences"
                        :type="TYPE_EXPERIENCE" :cardType="'V01'" :height="'50rem'" />
    ...
    <div class="w-full bg-white mt-8"
        style="background-image: url('{{ asset('images/people.jpg') }}'); background-size:cover;">
        <div
            class="flex flex-wrap md:flex-nowrap justify-center w-full lg:w-3/4 space-y-4 md:space-y-0 p-4 md:p-0 md:space-x-4 mx-auto h-full bg-white ">
