                    ...
                    <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                        ...
                        <div>
                            ...
                            <ul class="mt-2 space-y-2">
                                <li>
                                    <a href="/"
                                        class="transition-colors duration-300 text-gray-200 hover:text-blue-900">Sit
                                        amet</a>
                                </li>
                                <li>
                                    <a href="/"
                                ...
                                <li>
                                    <a href="/"
                                        class="transition-colors duration-300 text-gray-200 hover:text-blue-900">Vel
                                        sequi magni</a>
                                </li>
                                <li>
                                    <a href="/"
                        ...
                        <div>
                            ...
                            <ul class="mt-2 space-y-2">
                                <li>
                                    <a href="/"
                                        class="transition-colors duration-300 text-gray-200 hover:text-blue-900">Politica
                                        de
                                        privacidad</a>
                                </li>
                                <li>
