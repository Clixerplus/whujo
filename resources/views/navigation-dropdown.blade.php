            ...
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="/" aria-label="Whujo" title="Whujo" class="inline-flex items-center">
                        <span class="ml-2 text-3xl font-bold tracking-wide text-gray-800 font-whujo md:text-primary">whujo</span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-jet-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-jet-dropdown-link href="{{ route('account.profile') }}">
                            {{ __('Profile') }}
                        </x-jet-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                <!-- Account Management -->
                <x-jet-responsive-nav-link href="{{ route('account.profile') }}"
