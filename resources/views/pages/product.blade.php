<x-guest-layout>
    <section class="overflow-hidden">
        <ul class="grid grid-rows-1 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 h-80 lg:-mx-40">
            <li class="h-full bg-gray-900"></li>
            <li class="h-full bg-gray-800"></li>
            <li class="h-full bg-gray-700"></li>
            <li class="h-full bg-gray-500"></li>
        </ul>
    </section>
