<div>
    {{-- //TODO: cart-view Mejorar maquetacion  --}}
    <div :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'"
        class="fixed top-0 right-0 z-50 w-full h-full max-w-xs px-6 py-4 overflow-y-auto transition duration-300 transform bg-white border-l border-gray-200 shadow-xl">

        <div class="flex items-center justify-between">
            <h3 class="text-2xl font-medium text-gray-700">{{ __('Your cart') }}</h3>
